...
// Kill switch for the unified-batch greedy argmax fast path. The fast path is
// bit-identical to llama's greedy chain (first max over the logits row); this
// exists only to restore the llama_sampler_sample path for validation.
...
LlamaCppBackend::ExecuteUnifiedBatch(
  ...
  for (std::size_t i = 0; i < inputs.size(); ++i) {
    if (logit_indices[i] >= 0) {
      ...
      // First-max over the float row selects the identical token.
...
BackendInterface::ModelMetadata LlamaCppBackend::GetModelMetadata() const {
  ...
  // See llama.cpp ggml/include/ggml.h enum ggml_ftype for values.
  {
    ...
    case 1:
      ...
      break;
    case 2:
      meta.quantization = "Q4_0";
      break;
    case 3:
      meta.quantization = "Q4_1";
      break;
    case 7:
      meta.quantization = "Q8_0";
      break;
    case 8:
      meta.quantization = "Q5_0";
      break;
    case 9:
      meta.quantization = "Q5_1";
      break;
    case 10:
      meta.quantization = "Q2_K";
      break;
    case 11:
      meta.quantization = "Q3_K_S";
      break;
    case 12:
      meta.quantization = "Q3_K_M";
      break;
    case 13:
      meta.quantization = "Q3_K_L";
      break;
    case 14:
