...
|---|---|---|---|---|
| TD-001 | Restore a green, portable mainline baseline | P0 | Closed | None |
| [TD-002](TD-002-required-evidence-gates.md) | Make release evidence required and coherent | P0 | In Progress | None |
| [TD-003](TD-003-runtime-evidence-drift.md) | Eliminate benchmark and product-claim drift | P0 | Proposed | ADR-0001 |
| [TD-004](TD-004-cli-transport-seams.md) | Extract CLI transport, context, and daemon seams | P1 | Proposed | ADR-0002 |
