...
|---|---|---|---|
| [ADR-0001](ADR-0001-evidence-gated-runtime-portfolio.md) | Evidence-gated native runtime portfolio | Proposed | TD-006, TD-007 |
| [ADR-0002](ADR-0002-server-first-managed-local-transport.md) | Server-first CLI with managed local transport | Accepted | None |
