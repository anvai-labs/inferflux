...
- `INFERFLUX_CUDA_MMQ_MMA` / `INFERFLUX_CUDA_MMQ_MMA_MIN_BATCH` / `INFERFLUX_CUDA_MMQ_MMA_MAX_BATCH` — mma.sync int8 tensor-core MMQ family (Q4_K gate/up+QKV+o+down-proj, Q6_K down-proj; M ≥ min-batch; default ON)
